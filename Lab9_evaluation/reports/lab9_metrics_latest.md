# Lab9 evaluation report — 2026-09-16 18:54
...
| dsba_no_coop | 0.6538 | 0.3846 | 93 | 132 | 39 | 29.55 | 0.7143 | CHK1, CHK7 |
...
- **MAE** = 19.25 หน่วยกิต (เฉลี่ยจาก 8 run ที่มีข้อมูลครบ)
- **MAPE** = 14.98%
- คลาดเคลื่อนมากสุด: **dsba_no_coop** (39 หน่วยกิต)
...
|---|---|---|---|---|
| ait | 0.7561 | 0.8824 | 0.1429 | 1.0 |
| bit_no_coop | 0.8605 | 0.9167 | 0.5714 | 0.8812 |
| bit_coop | 0.7857 | 0.9429 | 0.0 | 0.0 |
| dsba_no_coop | 0.6522 | 0.8286 | 0.0909 | 0.476 |
| dsba_coop | 0.6 | 0.75 | 0.0 | 0.0 |
...
CHK1 เดิมบอกแค่ผ่าน/ไม่ผ่าน ไม่บอกขนาดความคลาดเคลื่อน — เพิ่ม MAE/MAPE ต่อยอด แล้ว (MAE=19.25 หน่วยกิต, MAPE=14.98% ข้ามทั้ง 7 หลักสูตร) เผยว่า run ที่ "fail CHK1" เหมือนกันหมด จริง ๆ คลาดเคลื่อนต่างกันมาก (dsba_no_coop แย่สุด 39 หน่วยกิต ขณะที่บาง run คลาดเคลื่อนแค่ ~5%)
