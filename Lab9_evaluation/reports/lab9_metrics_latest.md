# Lab9 evaluation report — 2026-09-22 13:27
...
- **MAE** = 18.25 หน่วยกิต (เฉลี่ยจาก 16 run ที่มีข้อมูลครบ)
- **MAPE** = 14.43%
...
- **it_coop vs it_coop_retry**
  - หน่วยกิตรวมในแผน: it_coop=132  vs  it_coop_retry=135  (ต่างกัน 2.2%) -> โอเค
...
CHK1 เดิมบอกแค่ผ่าน/ไม่ผ่าน ไม่บอกขนาดความคลาดเคลื่อน — เพิ่ม MAE/MAPE ต่อยอด แล้ว (MAE=18.25 หน่วยกิต, MAPE=14.43% ข้ามทั้ง 7 หลักสูตร) เผยว่า run ที่ "fail CHK1" เหมือนกันหมด จริง ๆ คลาดเคลื่อนต่างกันมาก (dsba_no_coop แย่สุด 36 หน่วยกิต ขณะที่บาง run คลาดเคลื่อนแค่ ~5%)
