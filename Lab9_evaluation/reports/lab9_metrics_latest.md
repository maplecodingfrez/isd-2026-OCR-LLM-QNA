# Lab9 evaluation report — 2026-09-26 01:05
...
|---|---|---|---|---|---|
| ait | 30 | 1.0 | 0.7333 | 0.7333 | 2.22 |
| bit_no_coop | 30 | 1.0 | 0.9 | 0.9 | 2.1 |
| bit_coop | 30 | 1.0 | 0.9 | 0.9 | 1.55 |
| dsba_no_coop | 30 | 1.0 | 1.0 | 0.9667 | 1.91 |
| dsba_coop | 30 | 1.0 | 0.9667 | 0.9667 | 2.13 |
| it_no_coop | 30 | 1.0 | 0.9333 | 0.9 | 2.02 |
| it_coop | 30 | 1.0 | 0.8333 | 0.8 | 1.5 |
...
ข้อจำกัดของตัววัดระดับ 2: หน้าที่คาดของคำถามรายเทอม = หน้าที่พบวิชาของเทอมนั้นบ่อยที่สุดในผล Lab 5 ซึ่งบางเล่มชี้ผิดหน้า (IT no_coop ชี้หน้าแผนสหกิจ PDF 38 เพราะ Tesseract อ่านรหัสวิชาหน้า 31 ไม่ออก; DSBA ชี้หน้าภาคผนวก PDF 353) — หน้าที่ระบบอ้างในกรณีนี้ตรวจกับหัวเทอมใน OCR ทั้งเล่มแล้วถูก จึงอัตราระดับ 2 ต่ำกว่าจริง · DSBA coop ไม่อ้างหน้าตารางแผน (เลขไฟล์ภาพไม่ตรงเลขหน้า PDF — ขัดกับหัวเทอมในเล่ม จึงไม่อ้าง)
