...
> **Branch นี้ (`Lab-6-separate`) เก็บเฉพาะงานของ Lab 6 (Field/Page/Category Evaluation, แยก output
> ต่อระดับ) รวมทั้ง Lab 4/5 ต่อยอดของ AIT/IT/BIT ที่ทำระหว่างแล็บนี้** ระบบเต็มที่รวมทุก Lab พร้อมวิธี
> ติดตั้ง/ใช้งานล่าสุด ดูที่ branch `main`
