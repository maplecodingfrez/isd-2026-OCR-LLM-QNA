...
**ตรวจความถูกต้องของ Ground Truth (ขั้นที่ทำโดยตั้งใจ):** ก่อนเชื่อเฉลย เราเทียบเฉลยกับตัวสกัดแล้วเปิด **ภาพเล่มจริง** ตรวจทุกแถวที่ไม่ตรงกัน (6 แถวที่เฉลยเดิมบอก "ไม่มี" แต่เล่มมีวิชาบังคับก่อน)
