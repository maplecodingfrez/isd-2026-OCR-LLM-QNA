...
> **Branch นี้ (`Lab-8`) เก็บเฉพาะงานของ Lab 8B (Curriculum DB + NL2SQL Q&A)** ระบบเต็มที่รวมทุก
> Lab พร้อมวิธีติดตั้ง/ใช้งานล่าสุด ดูที่ branch `main`
...
> Lab 4/5/6 (Curriculum Extraction, Page Mapping, Field/Page/Category Evaluation) และ Lab 7B
> (Curriculum OCR Extraction ด้วย Local VLM, early prototype) เป็นงานคนละ branch — ดูที่ `Lab-4` /
> `lab-5` / `Lab-6-separate` / `Lab-7` หรือ `main`
