...
> **Branch นี้ (`lab-5`) เก็บเฉพาะงานของ Lab 5 (Ground Truth Page Mapping)** ระบบเต็มที่รวมทุก Lab
...
> Lab 4 (Curriculum Extraction) เป็นงานคนละ branch — ดูที่ `Lab-4` หรือ `main`
